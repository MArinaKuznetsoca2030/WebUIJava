...
public class CustomLoggerProfInstrument implements WebDriverListener {
    private static Logger logger = LoggerFactory.getLogger(CustomLoggerProfInstrument.class);
